...
export default function Popover({ className, trigger: Trigger, body: Body }: PopoverProps) {
  ...
  return (
    <div className={clsx(className)}>
      <UI.Popover className="relative">
        {({ open }) => (
          <>
            <UI.Popover.Button>{triggerIsComponent ? <Trigger /> : Trigger}</UI.Popover.Button>
            <UI.Transition
              as={Fragment}
