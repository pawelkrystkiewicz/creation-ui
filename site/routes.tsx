...
const DynamicButtonToggleGroup = React.lazy(
  () => import('./pages/button-toggle-group')
)
...
const DynamicLoadingOverlay = React.lazy(
  () => import('./pages/loading-overlay')
)
...
const DynamicTimelineHorizontal = React.lazy(
  () => import('./pages/timeline-horizontal')
)
const DynamicTooltips = React.lazy(() => import('./pages/tooltips'))
const DynamicInputsText = React.lazy(() => import('./pages/inputs/text'))
const DynamicInputsTextarea = React.lazy(
  () => import('./pages/inputs/textarea')
)
